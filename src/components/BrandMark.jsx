...
export const BrandMark = (props) => {
  ...
  if (type === 'sticky') {
    return (
      <div className="brand-mark fixed bottom-1 right-1 opacity-50 hover:opacity-100  transition translate-x-24 hover:translate-x--0 z-10">
        <div className="brand-mark__wrapper flex items-center bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 border-rounded p-2">
          ...
          <div className="content cursor-pointer font-sans">
            <a href={src} className="text-black hover:text-black flex-inline flex-col items-center decoration-none">
              <img
                className="w-10 border-rounded"
                src={logoSrc}
                alt={title}
